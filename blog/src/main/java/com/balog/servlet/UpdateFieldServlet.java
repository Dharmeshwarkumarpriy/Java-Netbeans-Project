 ...
 */
@MultipartConfig
@WebServlet(name = "UpdateFieldServlet", urlPatterns = {"/UpdateFieldServlet"})
            ...
            /* TODO output your page here. You may use following sample code. */
               ...
               // Part photo = request.getPart("photo");
                ...
                BlogFieldDao bfd = new BlogFieldDao(FactoryProduct.getFactory());
                 ...
                 bfd.getFieldUpdate(id,blogType, title, discription);
...
//                }
                ...
                h.setAttribute("message", "Blog edited successfully ");
