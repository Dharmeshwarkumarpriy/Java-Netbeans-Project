...
<!-- Mirrored from dashlite.net/demo1/hotel/report-booking.jsp
                                                    ...
                                                    <div class="drodown"><a href="#"
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <ul class="link-list-opt no-bdr">
                                                                <li><a href="#"><span>Import Booking Report</span></a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                                                            ...
                                                                                            <div class="row gx-6 gy-3">
                                                                                                ...
                                                                                                <div class="col-6">
                                                                                                    <div
                                                                                                        class="form-group">
                                                                                                        <label
                                                                                                            class="overline-title overline-title-alt">Date</label><select
                                                                                                            class="form-select js-select2 js-select2-sm">
                                                                                                            <option
                                                                                                                value="any">
                                                                                                                All Time
                                                ...
                                                <div class="card-search search-wrap" data-search="search">
                                                    <div class="card-body">
                                                        <div class="search-content"><a href="#"
                                                                ...
                                                                placeholder="Search by room name"><button
                                            ...
                                            <div class="card-inner p-0">
                                                <div class="nk-tb-list nk-tb-ulist">
                                                    <div class="nk-tb-item nk-tb-head">
                                                        ...
                                                        <div class="nk-tb-col"><span class="sub-text">Room ID</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-mb"><span class="sub-text">Room
                                                                Type</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span
                                                                class="sub-text">From</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span
                                                                class="sub-text">To</span></div>
                                                        <div class="nk-tb-col"><span class="sub-text">Total
                                                                Amount</span></div>
                                                                    ...
                                                                    <ul class="link-tidy sm no-bdr">
                                                                        ...
                                                                        <li>
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox"
                                                                                    class="custom-control-input"
                                                                                    checked="" id="double"><label
                                                                                    class="custom-control-label"
                                                                                    for="double">Double</label></div>
                                                                        </li>
                                                                        <li>
                                                                            <div
                                                                                class="custom-control custom-control-sm custom-checkbox">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col"><span class="text-primary">565601</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-mb"><span>Single</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span>01 Jan 2021</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span>01 Fab 2021</span></div>
                                                        <div class="nk-tb-col" data-order="1229.99"><span
                                                                class="tb-amount">1229.99 <span class="currency">
                                                                    USD</span></span></div>
                                                        <div class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-1">
                                                                <li><a href="#" class="btn btn-trigger btn-icon"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#viewModal"
                                                                        data-bs-placement="top" title="View"><em
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col"><span class="text-primary">658742</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-mb"><span>Double</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span>11 Jan 2021</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span>01 Fab 2021</span></div>
                                                        <div class="nk-tb-col" data-order="10229.99"><span
                                                                class="tb-amount">10229.99 <span class="currency">
                                                                    USD</span></span></div>
                                                        <div class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-1">
                                                                <li><a href="#" class="btn btn-trigger btn-icon"
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col"><span class="text-primary">658882</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-mb"><span>Delux</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span>25 Jan 2021</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span>01 Fab 2021</span></div>
                                                        <div class="nk-tb-col" data-order="3229.99"><span
                                                                class="tb-amount">3229.99 <span class="currency">
                                                                    USD</span></span></div>
                                                        <div class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-1">
                                                                <li><a href="#" class="btn btn-trigger btn-icon"
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col"><span class="text-primary">659982</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-mb"><span>Super Delux</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span>29 Jan 2021</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span>01 Fab 2021</span></div>
                                                        <div class="nk-tb-col" data-order="4229.99"><span
                                                                class="tb-amount">4229.99 <span class="currency">
                                                                    USD</span></span></div>
                                                        <div class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-1">
                                                                <li><a href="#" class="btn btn-trigger btn-icon"
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col"><span class="text-primary">657782</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-mb"><span>Suit</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span>30 Jan 2021</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span>02 Fab 2021</span></div>
                                                        <div class="nk-tb-col" data-order="4339.99"><span
                                                                class="tb-amount">4339.99 <span class="currency">
                                                                    USD</span></span></div>
                                                        <div class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-1">
                                                                <li><a href="#" class="btn btn-trigger btn-icon"
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col"><span class="text-primary">653482</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-mb"><span>Super Delux</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span>01 Fab 2021</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span>02 Fab 2021</span></div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col"><span class="text-primary">643482</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-mb"><span>Super Delux</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span>30 Jan 2021</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span>02 Fab 2021</span></div>
                                                        <div class="nk-tb-col" data-order="3639.99"><span
                                                                class="tb-amount">3639.99 <span class="currency">
                                                                    USD</span></span></div>
                                                        <div class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-1">
                                                                <li><a href="#" class="btn btn-trigger btn-icon"
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col"><span class="text-primary">743482</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-mb"><span>Suit</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span>28 Jan 2021</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span>02 Fab 2021</span></div>
                                                        <div class="nk-tb-col" data-order="6934.20"><span
                                                                class="tb-amount">6934.20 <span class="currency">
                                                                    USD</span></span></div>
                                                        <div class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-1">
                                                                <li><a href="#" class="btn btn-trigger btn-icon"
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col"><span class="text-primary">843482</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-mb"><span>Delux</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span>03 Fab 2021</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span>15 Fab 2021</span></div>
                                                        <div class="nk-tb-col" data-order="6120.20"><span
                                                                class="tb-amount">6120.20 <span class="currency">
                                                                    USD</span></span></div>
                                                        <div class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-1">
                                                                <li><a href="#" class="btn btn-trigger btn-icon"
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col"><span class="text-primary">943482</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-mb"><span>Double</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span>26 Jan 2021</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span>20 Fab 2021</span></div>
                                                        <div class="nk-tb-col" data-order="7120.20"><span
                                                                class="tb-amount">7120.20 <span class="currency">
                                                                    USD</span></span></div>
                                                        <div class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-1">
                                                                <li><a href="#" class="btn btn-trigger btn-icon"
                                                    ...
                                                    <div class="nk-tb-item">
                                                        <div class="nk-tb-col nk-tb-col-check">
                                                            <div
                                                                class="custom-control custom-control-sm custom-checkbox notext">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    id="uid11"><label class="custom-control-label"
                                                                    for="uid11"></label></div>
                                                        </div>
                                                        <div class="nk-tb-col"><span class="text-primary">103482</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-mb"><span>Single</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span>20 Jan 2021</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span>23 Jan 2021</span></div>
                                                        <div class="nk-tb-col" data-order="720.20"><span
                                                                class="tb-amount">720.20 <span class="currency">
                                                                    USD</span></span></div>
                                                        <div class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-1">
                                                                <li><a href="#" class="btn btn-trigger btn-icon"
                            ...
                            <div class="card-inner p-0">
                                <div class="nk-tb-list nk-tb-ulist">
                                    ...
                                    <div class="nk-tb-item">
                                        ...
                                        <div class="nk-tb-col"><span class="tb-amount">229.99<span class="currency">
                                                    USD</span></span></div>
                                    </div>
                                    <div class="nk-tb-item">
                                        <div class="nk-tb-col"><span class="text-primary">AB-332</span></div>
                                        <div class="nk-tb-col tb-col-sm"><span
                                                class="tb-status text-warning">Pending</span></div>
                                        <div class="nk-tb-col tb-col-mb"><span>Delux</span></div>
                                        <div class="nk-tb-col tb-col-mb"><span
                                                class="tb-status text-success">Paid</span></div>
                                        <div class="nk-tb-col"><span class="tb-amount">329.99<span class="currency">
                                                    USD</span></span></div>
                                    </div>
                                    <div class="nk-tb-item">
                                        <div class="nk-tb-col"><span class="text-primary">AB-349</span></div>
                                        <div class="nk-tb-col tb-col-sm"><span
                                                class="tb-status text-success">Active</span></div>
                                        <div class="nk-tb-col tb-col-mb"><span>Super Delux</span></div>
                                        <div class="nk-tb-col tb-col-mb"><span
                                                class="tb-status text-success">Paid</span></div>
                                        <div class="nk-tb-col"><span class="tb-amount">549.99<span class="currency">
                                                    USD</span></span></div>
                                    </div>
                                    <div class="nk-tb-item">
                                        <div class="nk-tb-col"><span class="text-primary">AB-277</span></div>
                                        <div class="nk-tb-col tb-col-sm"><span
                                                class="tb-status text-success">Active</span></div>
                                        <div class="nk-tb-col tb-col-mb"><span>Continental</span></div>
                                        <div class="nk-tb-col tb-col-mb"><span
                                                class="tb-status text-success">Paid</span></div>
                                        <div class="nk-tb-col"><span class="tb-amount">249.49<span class="currency">
                                                    USD</span></span></div>
                                    </div>
                                </div>
                            </div>
