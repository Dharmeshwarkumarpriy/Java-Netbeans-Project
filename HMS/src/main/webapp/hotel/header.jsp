<%-- 
    Document   : header
    Created on : 20-Dec-2024, 10:08:43 am
    Author     : samresh
--%>
                                ...
                                <ul class="nk-quick-nav">
                                    ...
                                    <li class="dropdown user-dropdown"><a href="#" class="dropdown-toggle"
                                        ...
                                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-end dropdown-menu-s1">
                                            ...
                                            <div class="dropdown-inner">
                                                <ul class="link-list">
                                                    <li><a href="#"><em class="icon ni ni-user-alt"></em><span>View
                                                                Profile</span></a></li>
                                                    <li><a href="settings.jsp"><em
                                                                class="icon ni ni-setting-alt"></em><span>Account
                                                                Setting</span></a></li>
                                                    <li><a href="settings-activity-log.jsp"><em
                                            ...
                                            <div class="dropdown-inner">
                                                <ul class="link-list">
                                                    <li><a href="../logoutServlet"><em class="icon ni ni-signout"></em><span>Sign
                                                                out</span></a></li>
                                                </ul>
                                            </div>
                                        </div>
