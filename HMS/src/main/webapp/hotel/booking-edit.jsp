...
AddBookingDao abd = new AddBookingDao(FactoryProduct.getFactory());
        List<AddBooking> list=abd.getBookingUpdate();
    
%>

<!DOCTYPE html>
<html lang="zxx" class="js">
<!-- Mirrored from dashlite.net/demo1/hotel/booking-edit.jsp
...
<!--                                                <div class="col-md-6 col-lg-4 col-xxl-3">
                                                    <div class="form-group"><label class="form-label">Upload
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <div class="form-file"><input type="file" multiple
                                                                                          class="form-file-input" id="customFile" name="image"
                                                                                          value="<%=s.getImage()%>"><label
                                                ...
                                                <div class="col-md-6 col-lg-4 col-xxl-3">
                                                    <div class="form-group"><label class="form-label">Select an
                                                            package</label>
                                                        <div class="form-control-wrap"><select
                                                                class="form-select js-select2" name="straterPackage" value="<%=s.getStraterPackage()%>"
                                                                data-placeholder="Select multiple options">
                                                                <option value="<%=s.getStraterPackage()%>"><%=s.getStraterPackage()%></option>
                                                ...
                                                <div class="col-md-6 col-lg-4 col-xxl-3">
                                                    <div class="form-group"><label class="form-label">Select Room
                                                            Type</label>
                                                        <div class="form-control-wrap"><select
                                                                class="form-select js-select2" name="roomType" value="<%=s.getRoomType()%>">
                                                                <option value="<%=s.getRoomType()%>"><%=s.getRoomType()%></option>
                                                                <option value="Delux">Delux</option>
                                                                <option value="Super Delux">Super Delux
                                                                </option>
                                                    ...
                                                    <div class="form-group"><label class="form-label">Arrived
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <div class="form-icon form-icon-right"><em
                                                                ...
                                                                name="arrivedDate" value="<%=s.getArrivedDate()%>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-lg-4 col-xxl-3">
                                                    <div class="form-group"><label class="form-label">Depart
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <div class="form-icon form-icon-right"><em
                                                                ...
                                                                type="text" class="form-control date-picker"
                                                                data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd"
                                                                name="depatDate" value="<%=s.getDepatDate()%>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-lg-4 col-xxl-3">
                                                    <div class="form-group"><label class="form-label"
                                                            for="total-person">Total Person</label><input type="number"
                                                                  class="form-control" id="total-person" name="totalPerson"
                                                            placeholder="Total Person" value="<%=s.getTotalPerson()%>"></div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-gupro"><label class="form-label"
                                                            for="default-textarea">Note</label>
                                                        <div class="form-control-wrap"><textarea
                                                                class="form-control no-resize" name="note"
                                                                id="default-textarea"><%=s.getNote()%></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="form-group"><button type="submit"
                                                            class="btn btn-primary">Update Booking</button></div>
                                                </div>
                                            </div>
                                        </div>
                                        </form>
