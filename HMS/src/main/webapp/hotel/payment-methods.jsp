...
<!-- Mirrored from dashlite.net/demo1/hotel/payment-methods.jsp
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <ul class="link-list-opt no-bdr">
                                                                <li><a data-bs-toggle="modal"
                                                                        href="#add-pay-method"><span>Add Payment
                                                                            Method</span></a></li>
                                                                <li><a href="#"><span>Import Payment Method</span></a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                ...
                                                <table class="table table-tranx">
                                                    <thead>
                                                        <tr class="tb-tnx-head">
                                                            ...
                                                            <th class="tb-tnx-info"><span
                                                                    class="tb-tnx-desc d-none d-sm-inline-block"><span>Payment
                                                                        Name</span></span><span
                                                                    class="tb-tnx-date d-md-inline-block d-none"><span
                                                                        class="d-none d-md-block"><span>Email</span><span>Marchant
                                                                            ID</span></span></span></th>
                                                            <th class="tb-tnx-amount is-alt"><span
                                                                    class="tb-tnx-total">Currency Setting</span><span
                                                    ...
                                                    <tbody>
                                                        <tr class="tb-tnx-item">
                                                            <td class="tb-tnx-id"><a href="#"><span>1</span></a></td>
                                                            <td class="tb-tnx-info">
                                                                <div class="tb-tnx-desc"><span
                                                                        class="title">Paypal</span></div>
                                                                <div class="tb-tnx-date"><span
                                                                        class="date">info@softnio.com</span><span
                                                                        class="date">MNB68</span></div>
                                                            </td>
                                                            <td class="tb-tnx-amount is-alt">
                                                                <div class="tb-tnx-total"><span
                                                                        class="amount">USD</span></div>
                                                        ...
                                                        <tr class="tb-tnx-item">
                                                            <td class="tb-tnx-id"><a href="#"><span>2</span></a></td>
                                                            <td class="tb-tnx-info">
                                                                <div class="tb-tnx-desc"><span class="title">Paypal
                                                                        hosted</span></div>
                                                                <div class="tb-tnx-date"><span
                                                                        class="date">info@softnio.com</span><span
                                                                        class="date">99K4</span></div>
                                                            </td>
                                                            <td class="tb-tnx-amount is-alt">
                                                                <div class="tb-tnx-total"><span
                                                                        class="amount">USD</span></div>
                                                                <div class="tb-tnx-status"><span
                                                                        class="badge bg-danger">Inactive</span></div>
                                                            </td>
                                                            <td class="tb-tnx-action">
                                                                <div class="dropdown"><a
                                                                        class="text-soft dropdown-toggle btn btn-icon btn-trigger"
                                                        ...
                                                        <tr class="tb-tnx-item">
                                                            <td class="tb-tnx-id"><a href="#"><span>3</span></a></td>
                                                            <td class="tb-tnx-info">
                                                                <div class="tb-tnx-desc"><span class="title">Cash</span>
                                                                </div>
                                                                <div class="tb-tnx-date"><span
                                                                        class="date">ashley@softnio.com</span><span
                                                                        class="date">--:--</span></div>
                                                            </td>
                                                            <td class="tb-tnx-amount is-alt">
                                                                <div class="tb-tnx-total"><span
                                                        ...
                                                        <tr class="tb-tnx-item">
                                                            <td class="tb-tnx-id"><a href="#"><span>4</span></a></td>
                                                            <td class="tb-tnx-info">
                                                                <div class="tb-tnx-desc"><span class="title">Visa</span>
                                                                </div>
                                                                <div class="tb-tnx-date"><span
                                                                        class="date">larson@example.com</span><span
                                                                        class="date">WBO4</span></div>
                                                            </td>
                                                            <td class="tb-tnx-amount is-alt">
                                                                <div class="tb-tnx-total"><span
                                                                        class="amount">USD/Euro</span></div>
                                                                <div class="tb-tnx-status"><span
                                                                        class="badge bg-success">Active</span></div>
                                                            </td>
                                                            <td class="tb-tnx-action">
                                                        ...
                                                        <tr class="tb-tnx-item">
                                                            <td class="tb-tnx-id"><a href="#"><span>5</span></a></td>
                                                            <td class="tb-tnx-info">
                                                                <div class="tb-tnx-desc"><span
                                                                        class="title">E-Check</span></div>
                                                                <div class="tb-tnx-date"><span
                                                                        class="date">frances@example.com</span><span
                                                                        class="date">kk1</span></div>
                                                            </td>
                                                            <td class="tb-tnx-amount is-alt">
                                                                <div class="tb-tnx-total"><span
                                                                        class="amount">USD/Euro</span></div>
            ...
            <div class="modal-content"><a href="#" class="close" data-bs-dismiss="modal"><em
                ...
                <div class="modal-body modal-body-md">
                    ...
                    <form action="#" class="mt-2">
                        <div class="row g-gs">
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="payment-name-add">Payment
                                        Name</label><input type="text" class="form-control" id="payment-name-add"
                                        placeholder="Payment Name"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="email-add">Email</label><input
                                        type="email" class="form-control" id="email-add"
                                        placeholder="example@email.com"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="march-id-add">Marchant
                                        Id</label><input type="number" class="form-control" id="march-id-add"
                                        placeholder="Marchant Id"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label"
                                        for="currency-add">Currency</label><input type="text" class="form-control"
                                        id="currency-add" placeholder="USD"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="status-add">Status</label><select
                                        class="form-select js-select2" id="status-add">
                            ...
                            <div class="col-12">
                                <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                    <li><button class="btn btn-primary">Add Payment Method</button></li>
            ...
            <div class="modal-content"><a href="#" class="close" data-bs-dismiss="modal"><em
                ...
                <div class="modal-body modal-body-md">
                    ...
                    <form action="#" class="mt-2">
                        <div class="row g-gs">
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="payment-name-edit">Payment
                                        Name</label><input type="text" class="form-control" id="payment-name-edit"
                                        value="Paypal" placeholder="Payment Name"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="email-edit">Email</label><input
                                        type="email" class="form-control" id="email-edit" value="info@softnio.com"
                                        placeholder="example@email.com"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="march-id-edit">Marchant
                                        Id</label><input type="text" class="form-control" value="MNB68"
                                        id="march-id-edit" placeholder="Marchant Id"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label"
                                        for="currency-edit">Currency</label><input type="text" class="form-control"
                                        value="USD" id="currency-edit" placeholder="USD"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label"
