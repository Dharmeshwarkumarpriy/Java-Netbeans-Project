...
<html lang="zxx" class="js">
    <!-- Mirrored from dashlite.net/demo1/hotel/bookings.jsp
    by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Dec 2024 12:49:43 GMT -->
    <!-- Added by HTTrack -->
                                            ...
                                            <div class="card-inner-group">
                                                ...
                                                <div class="card-inner p-0">
                                                    <div class="nk-tb-list nk-tb-ulist">
                                                        ...
                                                        <%for (AddBooking s : list) {%>
                                                        <div class="nk-tb-item">
                                                            <div class="nk-tb-col nk-tb-col-check">
                                                                <div
                                                                    class="custom-control custom-control-sm custom-checkbox notext">
                                                                    <a href="bookings.jsp"></a>
                                                                    <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <div class="nk-tb-col"><a href="#">
                                                                    <div class="user-card">
                                                                        ...
                                                                        <div class="user-avatar bg-primary"><span><img src="../Img/booking/<%=s.getImage()%>" class="img-fluid rounded-start" alt="..." id="icons"/>
                                                                            </span></div>
                                                                             
                                                                        <div class="user-info"><span class="tb-lead"><%=s.getFirstName()%> <%=s.getLastName()%><span
                                                                                    class="dot dot-warning d-md-none ms-1"></span></span><span><%=s.getEmail()%></span>
                                                                        </div>
                                                                    </div>
                                                                </a></div>
                                                                       
                                                            <div class="nk-tb-col tb-col-mb"><span><%=s.getStraterPackage()%></span></div>
                                                            <div class="nk-tb-col tb-col-md"><span
                                                                    class="tb-status text-success"><%=s.getId()%>Active</span></div>
                                                            <div class="nk-tb-col tb-col-lg"><span><%=s.getRoomType()%></span></div>
                                                            <div class="nk-tb-col tb-col-xxl"><span><%=s.getPhone()%></span>
                                                            </div>
                                                            <div class="nk-tb-col tb-col-lg"><span><%=s.getArrivedDate()%></span></div>
                                                            <div class="nk-tb-col tb-col-md"><span
                                                                    class="tb-status text-success"><%=s.getId()%>Paid</span></div>
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                    <li><a href="#"><em
                                                                                                ...
                                                                                                Email</span></a></li>
                                                                                    <li><a href="booking-edit.jsp?id=<%=s.getId()%>
                                                                                           "><em
