...
<!-- Mirrored from dashlite.net/demo1/hotel/settings-activity-log.jsp
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="tb-col-time"><span class="sub-text"><span
                                                                            class="badge bg-danger ms-0">Deleted</span></span>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="tb-col-time"><span class="sub-text">11:34
                                                                        PM</span></td>
                                                                <td class="tb-col-time"><span class="sub-text"><span
                                                                            class="badge bg-success ms-0">Updated</span></span>
                                                                </td>
                                                                <td class="tb-col-action"><a href="#"
                                                                        class="link-cross me-sm-n1"><em
                                                                            class="icon ni ni-cross"></em></a></td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="tb-col-time"><span class="sub-text">11:34
                                                                        PM</span></td>
                                                                <td class="tb-col-time"><span class="sub-text"><span
                                                                            class="badge bg-primary ms-0">Created</span></span>
                                                                </td>
                                                                <td class="tb-col-action"><a href="#"
                                                                        class="link-cross me-sm-n1"><em
                                                                            class="icon ni ni-cross"></em></a></td>
                                                ...
                                                <div class="card-inner-group" data-simplebar>
                                                    ...
                                                    <div class="card-inner p-0">
                                                        <ul class="link-list-menu">
                                                            ...
                                                            <li><a class="active" href="settings-activity-log.jsp
                                                                   "><em
