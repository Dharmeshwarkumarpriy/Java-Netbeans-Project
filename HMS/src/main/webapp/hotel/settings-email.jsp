...
<!-- Mirrored from dashlite.net/demo1/hotel/settings-email.jsp
                                    ...
                                    <div class="card card-bordered">
                                        <div class="card-aside-wrap">
                                            <div class="card-inner card-inner-lg">
                                                <div class="nk-block-head nk-block-head-lg">
                                                    <div class="nk-block-between">
                                                        <div class="nk-block-head-content">
                                                            <h5 class="nk-block-title">E-mail settings</h5><span>These
                                                                settings are helps you modify your e-mail.</span>
                                                        </div>
                                                ...
                                                <div class="nk-block">
                                                    <form action="../EmailSettingsServlet" method="post">
                                                        <div class="row g-3 align-center">
                                                            <div class="col-lg-5">
                                                                <div class="form-group"><label class="form-label"
                                                                        for="site-name">Email</label><span
                                                                        class="form-note">Specify the email of your
                                                                        hotel.</span></div>
                                                            </div>
                                                            <div class="col-lg-7">
                                                                <div class="form-group">
                                                                    <div class="form-control-wrap"><input type="text"
                                                                            class="form-control" id="site-name" name="email"
                                                        ...
                                                        <div class="row g-3 align-center">
                                                            <div class="col-lg-5">
                                                                <div class="form-group"><label class="form-label"
                                                                        for="site-email">Password</label><span
                                                                        class="form-note">Specify the email
                                                                        password.</span></div>
                                                            </div>
                                                            <div class="col-lg-7">
                                                                <div class="form-group">
                                                                    <div class="form-control-wrap"><input type="text"
                                                                            class="form-control" id="site-email" name="password"
                                                                            value="Nio35@**"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row g-3 align-center">
                                                            <div class="col-lg-5">
                                                                <div class="form-group"><label class="form-label"
                                                                        for="site-copyright">SMTP Host</label><span
                                                                        class="form-note">Specify the SMTP host of your
                                                                        email address.</span></div>
                                                            </div>
                                                            <div class="col-lg-7">
                                                                <div class="form-group">
                                                                    <div class="form-control-wrap"><input type="text"
                                                                            class="form-control" id="site-copyright" name="smtphost"
                                                        ...
                                                        <div class="row g-3 align-center">
                                                            <div class="col-lg-5">
                                                                <div class="form-group"><label class="form-label">SMTP
                                                                        Port</label><span class="form-note">Specify the
                                                                        email SMTP port.</span></div>
                                                            </div>
                                                            <div class="col-lg-7">
                                                                <div class="form-group">
                                                                    <div class="form-control-wrap"><input type="text"
                                                                            class="form-control" id="site-port" name="smtpport"
                                                                            value="921"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row g-3 align-center">
                                                            <div class="col-lg-5">
                                                                <div class="form-group"><label class="form-label">SMTP
                                                                        Encryption</label><span
                                                                        class="form-note">Specify the encryption of your
                                                                        hotel email.</span></div>
                                                            </div>
                                                            <div class="col-lg-7">
                                                                <div class="form-group">
                                                                    <div class="form-control-wrap"><input type="text"
                                                                            class="form-control" name="smtpencryption"
                                                                            value="ITS"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="card-inner-group" data-simplebar>
                                                    ...
                                                    <div class="card-inner p-0">
                                                        <ul class="link-list-menu">
                                                            ...
                                                            <li><a class="active" href="settings-email.jsp
                                                                   "><em
