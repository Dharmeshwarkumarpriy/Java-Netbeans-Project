...
<html lang="zxx" class="js">
    ...
    <body class="nk-body bg-lighter npc-general has-sidebar ">
                                                    ...
                                                    <div class="nk-tb-list nk-tb-ulist">
                                                       ...
                                                       <%
                                                        ...
                                                        <div class="nk-tb-item">
                                                            ...
                                                            <div class="nk-tb-col"><span class="text-primary"><%=addroom.getRoomNo()%></span>
                                                            </div>
                                                            <div class="nk-tb-col"><span><%=addroom.getRoomType()%> <span
                                                                        class="dot dot-primary d-md-none ms-1"></span></span>
                                                            </div>
                                                            <div class="nk-tb-col tb-col-md"><span><%=addroom.getAirCondition()%></span></div>
                                                            <div class="nk-tb-col tb-col-lg"><span><%=addroom.getMeal()%></span></div>
                                                            <div class="nk-tb-col tb-col-lg"><span><%=addroom.getBedCapacity()%></span></div>
                                                            <div class="nk-tb-col tb-col-mb"><span class="tb-amount"><%=addroom.getRoomPrice()%>
                                                                    <span class="currency">USD</span></span></div>
                                                            <div class="nk-tb-col tb-col-md"><span
                                                                    class="tb-status text-primary"><%=addroom.getStatus()%></span></div>
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                    <li><a data-bs-toggle="modal"
                                                                                           href="#edit-room<%=addroom.getId()%>"><em
                                                                                                class="icon ni ni-edit"></em><span>Edit</span></a>
                                                                                    </li>
                                                                                    <li><a href="../DeleteAddRoom?id=<%=addroom.getId()%>"<em
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content"><a href="#" class="close" data-bs-dismiss="modal"><em
                    ...
                    <div class="modal-body modal-body-md">
                        ...
                        <form action="../AddRoomServlet" method="post" enctype="multipart/form-data" class="mt-2">
                            <div class="row g-gs">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group"><label class="form-label" for="floorNo">Floor No</label><input
                                            type="text" class="form-control" name="floorNo" placeholder="floor no"></div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group"><label class="form-label">Bed Type</label>
                                        <div class="form-control-wrap"><select class="form-select js-select2" name="bedType">
                                                <option value="Single">Single</option>
                                                <option value="Double">Double</option>
                                                <option value="Triple">Tripless</option>
                                            </select></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group"><label class="form-label" for="bed-no-add">Bed
                                            Capacity</label><input type="text" class="form-control" name="bedCapacity"
                                                               placeholder="Bed Capacity"></div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group"><label class="form-label">Meal</label>
                                        <div class="form-control-wrap"><select class="form-select js-select2" name="meal"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group"><label class="form-label" for="rent-add">Rent</label><input
                                            type="number" class="form-control" name="roomPrice" placeholder=" Room Rent"></div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group"><label class="form-label">Room Clean</label>
                                        <div class="form-control-wrap"><select class="form-select js-select2" name="roomClean"
                                                                               data-placeholder="Select multiple options">
                                                <option value="default_option">None</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group"><label class="form-label" for="roomImage">Room Image</label><input
                                            type="file" class="form-control" name="roomImage" placeholder="Room Image"></div>
                                </div>

                                <div class="col-md-6">
                                    <div class="form-group"><label class="form-label" for="roomImage">Balcony Image</label><input
                                            type="file" class="form-control" name="balconyImage" placeholder="Balcony Image"></div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group"><label class="form-label" for="bedImage">Bed Image</label><input
                                            type="file" class="form-control" name="bedImage" placeholder="Bed Image"></div>
                                </div>

                                <div class="col-md-6">
                                    <div class="form-group"><label class="form-label" for="roomImage">Bath Room Image</label><input
                                            type="file" class="form-control" name="bathRoomImage" placeholder="Bath Room Image"></div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group"><label class="form-label"
                                                                   for="default-textarea">Room Descriptipn</label>
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="edit-room<%=s.getId() %>">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content"><a href="#" class="close" data-bs-dismiss="modal"><em
                            class="icon ni ni-cross-sm"></em></a>
                            ...
                            <div class="row g-gs">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group"><label class="form-label" for="room-no-edit">Room
                                            No</label><input type="text" class="form-control" name="roomNo"
                                                         value="<%=s.getRoomNo()%>" placeholder="Room No"></div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group"><label class="form-label">Room Type</label>
                                        <div class="form-control-wrap"><select class="form-select js-select2" value="<%=s.getRoomType()%>" name="roomType">
                                                <option value="<%=s.getRoomType()%>"><%=s.getRoomType()%></option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group"><label class="form-label">Air Conditon</label>
                                        <div class="form-control-wrap"><select class="form-select js-select2" value="<%=s.getAirCondition()%>" name="airCondition">
                                                <option value="Ac">Ac</option>
                                                <option value="Non Ac">Non AC</option>
                               ...
                               <div class="col-md-6">
                                    <div class="form-group"><label class="form-label">Meal</label>
                                        <div class="form-control-wrap"><select class="form-select js-select2" name="meal" value="<%=s.getMeal()%>"
                                                                               data-placeholder="Select multiple options">
                                    ...
                                    <div class="form-group"><label class="form-label" for="bed-no-edit">Bed
                                            Capacity</label><input type="text" class="form-control" name="bedCapacity" value="<%=s.getBedCapacity()%>"
                                                               placeholder="Bed Capacity"></div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group"><label class="form-label" for="rent-edit">Rent</label><input
                                            type="text" class="form-control" name="roomPrice" value="<%=s.getRoomPrice()%>"
                                            placeholder="0.00 USD"></div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group"><label class="form-label">Status</label>
                                        <div class="form-control-wrap"><select class="form-select js-select2" name="status" value="<%=s.getStatus()%>"
                                                                               data-placeholder="Select multiple options">
                                                <option value="Active">Active</option>
                                                <option value="InActive">InActive</option>
                                            </select></div>
