<%-- 
    Document   : report-edit-expenses
    Created on : Dec 29, 2024, 7:26:57 AM
    Author     : dell
--%>
...
ReportExpensesDao red = new ReportExpensesDao(FactoryProduct.getFactory());
    List<ReportExpenses> list = red.getbyId(id);
                                        ...
                                        <div class="card card-bordered card-stretch">
                                            <div class="card-inner-group">
                                                ...
                                                <div class="card-inner p-5">
                                                    <h3 class="nk-block-title page-title">Update Expenses</h3>
                                                    <div class="nk-tb-list nk-tb-ulist">

                                                        <%for (ReportExpenses s : list) {%>
                                                        <div class="nk-tb-item">
                                                            <form action="../UpdateReportExpensesServlet" method="post" class="mt-2">
                                                                <div class="row g-gs">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group"><label class="form-label" for="supplier-name">Supplier
                                                                                Name</label><input type="text" class="form-control" id="supplier-name" name="supplierName"
                                                                                      value="<%=s.getSupplierName()%>"  placeholder="Supplier Name" autofocus></div>
                                                                    </div>
                                                                     <input type="hidden" value="<%=s.getId()%>" name="id">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group"><label class="form-label"
                                                                                                       for="description">Description</label><input type="text" class="form-control"
                                                                                                             id="description" value="<%=s.getDiscription()%>" name="discription" placeholder="Description"></div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group"><label class="form-label">Date</label>
                                                                            <div class="form-control-wrap">
                                                                                <div class="form-icon form-icon-right"><em class="icon ni ni-calendar"></em>
                                                                                      ...
                                                                                      data-date-format="yyyy-mm-dd" value="<%=s.getDate()%>" name="date" placeholder="yyyy-mm-dd">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group"><label class="form-label" for="amount">Amount</label><input
                                                                                type="number" class="form-control" id="amount" value="<%=s.getAmount()%>" name="amount" placeholder="300.99 USD"></div>
                                                                    </div>
                                                                    <div class="col-12">
                                                                        <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                                                            <li><button type="submit" class="btn btn-primary">Update Expenses</button></li>
