...
<!-- Mirrored from dashlite.net/demo1/hotel/support.jsp
...
<body class="nk-body bg-lighter npc-general has-sidebar ">
                                    ...
                                    <div class="nk-msg-aside">
                                        <div class="nk-msg-nav">
                                            <ul class="nk-msg-menu">
                                                ...
                                                <li class="nk-msg-menu-item ms-auto"><a href="#"
                                                        class="search-toggle toggle-search" data-target="search"><em
                                                ...
                                                <div class="d-none d-lg-block">
                                                    <ul class="nk-msg-tags">
                                                        <li><span class="label-tag"><em
                                                                    class="icon ni ni-flag-fill"></em> <span>Technical
                                                    ...
                                                    <li class="dropdown"><a href="#"
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <ul class="link-list-opt no-bdr">
                                                                <li><a href="#"><em
                                                                            class="icon ni ni-user-add"></em><span>Assign
                                                                            To Member</span></a></li>
                                                                <li><a href="#"><em
                                                                            class="icon ni ni-archive"></em><span>Move
                                                                            to Archive</span></a></li>
                                                                <li><a href="#"><em
                                                                            class="icon ni ni-done"></em><span>Mark as
                                                                            Close</span></a></li>
                                                            </ul>
                                                        </div>
                                                    </li>
                                                ...
                                                <div class="nk-reply-form-header">
                                                    <ul class="nav nav-tabs-s2 nav-tabs nav-tabs-sm">
                                                        <li class="nav-item"><a class="nav-link active"
                                                                data-toggle="tab" href="#reply-form">Reply</a></li>
                                                            ...
                                                            <div class="nk-reply-form-tools">
                                                                <ul class="nk-reply-form-actions g-1">
                                                                    ...
                                                                    <li>
                                                                        <div class="dropdown"><a
                                                                                ...
                                                                                data-bs-toggle="dropdown" href="#"><em
                                                                                    class="icon ni ni-hash"
                                                                                    data-bs-toggle="tooltip"
                                                                                    data-bs-placement="top"
                                                                                    title="Template"></em></a>
                                                                            <div class="dropdown-menu">
                                                                                <ul
                                                                                    class="link-list-opt no-bdr link-list-template">
                                                                    ...
                                                                    <li><a class="btn btn-icon btn-sm"
                                                                            data-bs-toggle="tooltip"
                                                                            data-bs-placement="top"
                                                                            title="Upload Attachment" href="#"><em
                                                                                class="icon ni ni-clip-v"></em></a></li>
                                                                    <li><a class="btn btn-icon btn-sm"
                                                                            data-bs-toggle="tooltip"
                                                                            data-bs-placement="top" title="Insert Emoji"
                                                                            href="#"><em
                                                                                class="icon ni ni-happy"></em></a></li>
                                                                    <li><a class="btn btn-icon btn-sm"
                                                                            data-bs-toggle="tooltip"
                                                                            data-bs-placement="top"
                                                                            title="Upload Images" href="#"><em
                                                    ...
                                                    <div class="tab-pane" id="note-form">
                                                        <div class="nk-reply-form-editor">
                                                            ...
                                                            <div class="nk-reply-form-tools">
                                                                <ul class="nk-reply-form-actions g-1">
                                                                    <li class="me-2"><button class="btn btn-primary"
                                                                            type="submit">Add Note</button></li>
                                                                    <li><a class="btn btn-icon btn-sm"
                                                                            data-bs-toggle="tooltip"
                                                                            data-bs-placement="top"
                                                                            title="Upload Attachment" href="#"><em
                                                        ...
                                                        <div class="row text-center g-1">
                                                            <div class="col-4">
                                                                <div class="profile-stats"><span
                                                                        class="amount text-purple">30</span><span
                                                        ...
                                                        <div class="aside-wg">
                                                            ...
                                                            <div class="row gx-1 gy-3">
                                                                ...
                                                                <div class="col-6"><span
                                                                        class="sub-text">Requested:</span><span>Abu Bin
                                                                        Ishtiak</span></div>
                                                                <div class="col-6"><span
    ...
    <script src="../assets/js/apps/messagese1e3.js?ver=3.2.4"></script>
</body>
<!-- Mirrored from dashlite.net/demo1/hotel/support.jsp
by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Dec 2024 12:49:45 GMT -->
