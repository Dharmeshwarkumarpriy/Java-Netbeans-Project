...
<!-- Mirrored from dashlite.net/demo1/hotel/booking-add.jsp
    ...
    <div class="nk-app-root">
        <div class="nk-main ">
            ...
            <div class="nk-wrap ">
               ...
               <form action="../AddBookingServlet" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row gy-4">
                                                ...
                                                <div class="col-md-6 col-lg-4 col-xxl-3">
                                                    <div class="form-group"><label class="form-label">Gender</label>
                                                        <div class="form-control-wrap"><select
                                                                class="form-select js-select2" name="gender"
                                                ...
                                                <div class="col-md-6 col-lg-4 col-xxl-3">
                                                    <div class="form-group"><label class="form-label">Select an
                                                            package</label>
                                                        <div class="form-control-wrap"><select
                                                                class="form-select js-select2" name="straterPackage"
                                                                data-placeholder="Select multiple options">
                                                ...
                                                <div class="col-md-6 col-lg-4 col-xxl-3">
                                                    <div class="form-group"><label class="form-label">Select Room
                                                            Type</label>
                                                        <div class="form-control-wrap"><select
                                                                class="form-select js-select2" name="roomType">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group"><button type="submit"
                                                            class="btn btn-primary">Add Booking</button></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
