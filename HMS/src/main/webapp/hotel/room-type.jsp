...
<!-- Mirrored from dashlite.net/demo1/hotel/room-type.jsp
...
<body class="nk-body bg-lighter npc-general has-sidebar ">
    ...
    <%
        AddRoomTypeDao adrtDao=new AddRoomTypeDao(FactoryProduct.getFactory());
        List<AddRoomType>list=adrtDao.getAllRoomType();
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <ul class="link-list-opt no-bdr">
                                                                <li><a data-bs-toggle="modal"
                                                                        href="#add-room-type"><span>Add Room
                                                                            Type</span></a></li>
                                            ...
                                            <div class="card-inner p-0">
                                                <div class="nk-tb-list nk-tb-ulist">
                                                    <div class="nk-tb-item nk-tb-head">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb"><span class="sub-text">Rent
                                                                (Basic)</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span class="sub-text">Short
                                                                Code</span></div>
                                                        <div class="nk-tb-col tb-col-lg"><span class="sub-text">No Of
                                                                Room</span></div>
                                                                        ...
                                                                        <li>
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox"
                                                                                    ...
                                                                                    checked="" id="active"><label
                                                                                    class="custom-control-label"
                                                                                    for="active">Active</label></div>
                                                                        </li>
                                                                        <li>
                                                                            <div
                                                                                class="custom-control custom-control-sm custom-checkbox">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col"><span class="text-primary"><%=d.getId()%></span>
                                                        </div>
                                                        <div class="nk-tb-col"><span><%=d.getRoomName()%><span
                                                                    class="dot dot-success d-md-none ms-1"></span>
                                                            </span></div>
                                                        <div class="nk-tb-col tb-col-mb" data-order="30.99"><span
                                                                class="tb-amount"><%=d.getRoomPrice()%><span
                                                                    class="currency">USD</span></span></div>
                                                        <div class="nk-tb-col tb-col-md"><span><%=d.getShortCode()%></span></div>
                                                        <div class="nk-tb-col tb-col-lg"><span><%=d.getNoOfRoom()%></span></div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                            <ul class="d-flex text-warning">
                                                                <li><em class="icon ni ni-star-fill" ><%=d.getStarType()%></em></li>
                                                        ...
                                                        <div class="nk-tb-col tb-col-md"><span
                                                                class="tb-status text-success"><%=d.getStatus()%></span></div>
                                                            ...
                                                            <ul class="nk-tb-actions gx-1">
                                                                <li>
                                                                    <div class="drodown"><a href="#"
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-end">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                <li><a data-bs-toggle="modal" href="#add-room-type<%=d.getId()%>"><em
                                                                                            class="icon ni ni-edit"></em><span>Edit</span></a>
                                                                                </li>
                                                                                <li><a href="../DeleteAddRoomTypeServlet?id=<%=d.getId()%>"><em
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content"><a href="#" class="close" data-bs-dismiss="modal"><em
                ...
                <div class="modal-body modal-body-md">
                    ...
                    <form action="../AddRoomTypeServlet" method="post" class="mt-2">
                        <div class="row g-gs">
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="room-name">Room
                                        Name</label><input type="text" class="form-control" name="roomName"
                                        placeholder="Room name"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="rent">Rent</label><input
                                        type="number" class="form-control" name="roomPrice" placeholder="30.99 USD"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="code">Short Code</label><input
                                        type="text" class="form-control" name="shortCode" placeholder="Short Code"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="no-of-room">Number of
                                        Room</label><input type="text" class="form-control" name="noOfRoom"
                                        placeholder="Number of Room"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="star">Type</label><input
                                        type="text" class="form-control" name="starType" placeholder="3 Star"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="status">Status</label><select
                                        class="form-select js-select2" name="status">
                            ...
                            <div class="col-12">
                                <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                    <li><button class="btn btn-primary">Add Room Type</button></li>
             ...
             <%
                                                        ...
                                                        %>
            <div class="modal fade" tabindex="-1" role="dialog" id="add-room-type<%=d.getId()%>">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content"><a href="#" class="close" data-bs-dismiss="modal"><em
                        class="icon ni ni-cross-sm"></em></a>
                <div class="modal-body modal-body-md">
                    <h5 class="modal-title">Edit Add Room Type</h5>
                    <form action="../UpdateAddRoomTypeServlet" method="post" class="mt-2">
                        <div class="row g-gs">
                            <div class="col-md-6">
                                 <input type="hidden" value="<%=d.getId()%>" name="id">
                                <div class="form-group"><label class="form-label" for="room-name">Room
                                        Name</label><input type="text" class="form-control" name="roomName" value="<%=d.getRoomName()%>"
                                        placeholder="Room name"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="rent">Rent</label><input
                                        type="number" class="form-control" name="roomPrice" value="<%=d.getRoomPrice()%>" placeholder="30.99 USD"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="code">Short Code</label><input
                                        type="text" class="form-control" name="shortCode" value="<%=d.getShortCode()%>" placeholder="Short Code"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="no-of-room">Number of
                                        Room</label><input type="text" class="form-control" name="noOfRoom" value="NoOfRoom"
                                        placeholder="Number of Room"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="star">Type</label><input
                                        type="text" class="form-control" name="starType" value="<%=d.getStarType()%>" placeholder="3 Star"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="status">Status</label><select
                                        class="form-select js-select2" name="status" value="<%=d.getStatus()%>">
                                        <option>Active</option>
                                        <option>Inactive</option>
                                    </select></div>
                            </div>
