...
<!-- Mirrored from dashlite.net/demo1/hotel/settings.jsp
by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Dec 2024 12:49:45 GMT -->
<!-- Added by HTTrack -->
    ...
    <div class="nk-app-root">
        <div class="nk-main ">
            ...
            <div class="nk-wrap ">
                ...
                <form action="../GeneralSettingsServlet" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="card-inner card-inner-lg">
                                                <div class="nk-block-head nk-block-head-lg">
                                                    <div class="nk-block-between">
                                                        <div class="nk-block-head-content">
                                                            <h5 class="nk-block-title">General settings</h5><span>These
                                                ...
                                                <div class="nk-block">
                                                        ...
                                                        <div class="row g-3 align-center">
                                                            <div class="col-lg-5">
                                                                <div class="form-group"><label class="form-label"
                                                                        for="site-name">Hotel Name</label><span
                                                            ...
                                                            <div class="col-lg-7">
                                                                <div class="form-group">
                                                                    <div class="form-control-wrap"><input type="text"
                                                                            class="form-control" id="site-name" name="hotelName"
                                                                            value="Dashlite HMS"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row g-3 align-center">
                                                            <div class="col-lg-5">
                                                                <div class="form-group"><label class="form-label">Hotel
                                                                        Logo</label><span class="form-note">The logo of
                                                                        your hotel</span></div>
                                                            </div>
                                                            <div class="col-lg-7">
                                                                <div class="form-group">
                                                                    <div class="form-control-wrap">
                                                                        <div class="form-file"><input type="file"
                                                                                multiple class="form-file-input"
                                                                                id="customFile" name="hotelLogo"><label
                                                        ...
                                                        <div class="row g-3 align-center">
                                                            <div class="col-lg-5">
                                                                <div class="form-group"><label class="form-label"
                                                                        for="site-address">Hotel Address</label><span
                                                                        class="form-note">Specify the name of your hotel
                                                                        address.</span></div>
                                                            </div>
                                                            <div class="col-lg-7">
                                                                <div class="form-group">
                                                                    <div class="form-control-wrap"><input type="text"
                                                                            class="form-control" id="site-address" name="hotelAddress"
                                                                            value="323  Hinkle Lake Road, Cambridge, Massachusetts">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row g-3 align-center">
                                                            ...
                                                            <div class="col-lg-7">
                                                                <div class="form-group">
                                                                    <div class="form-control-wrap"><input type="text"
                                                                                                          class="form-control" id="site-copyright" name="copyRight"
                                                                            value="&copy; 2024, DashLite. All Rights Reserved.">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row g-3 align-center">
                                                            <div class="col-lg-5">
                                                                <div class="form-group"><label class="form-label">Main
                                                                        ...
                                                                        URL if your main website.</span></div>
                                                            </div>
                                                            <div class="col-lg-7">
                                                                <div class="form-group">
                                                                    <div class="form-control-wrap"><input type="text"
                                                                            class="form-control" name="mainSite"
                                                        ...
                                                        <div class="row g-3 align-center">
                                                            <div class="col-lg-5">
                                                                <div class="form-group"><label
                                                                        class="form-label">Facebook</label><span
                                                                        class="form-note">Specify the URL if your
                                                            ...
                                                            <div class="col-lg-7">
                                                                <div class="form-group">
                                                                    <div class="form-control-wrap"><input type="text"
                                                                            ...
                                                                            value="https://www.facebook.com"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row g-3 align-center">
                                                            <div class="col-lg-5">
                                                                <div class="form-group"><label
                                                                        class="form-label">Instagram</label><span
                                                                        class="form-note">Specify the URL if your
                                                                        instagram page.</span></div>
                                                            </div>
                                                            <div class="col-lg-7">
                                                                <div class="form-group">
                                                                    <div class="form-control-wrap"><input type="text"
                                                                            class="form-control" name="instagram"
                                                                            value="https://www.instagram.com"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row g-3 align-center">
                                                            ...
                                                            <div class="col-lg-7">
                                                                <div class="form-group">
                                                                    <div class="custom-control custom-switch"><input
                                                                            ...
                                                                            name="maintananceMode" id="site-off"><label
...
<!-- Mirrored from dashlite.net/demo1/hotel/settings.jsp
by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Dec 2024 12:49:46 GMT -->
