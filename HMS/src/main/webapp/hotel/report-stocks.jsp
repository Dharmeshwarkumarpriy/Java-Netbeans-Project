...
<%@page import="com.hms.Dao.ReportStocksDao"%>
<%@page import="com.hms.Entity.ReportStocks"%>

<%
ReportStocksDao rsd = new ReportStocksDao(FactoryProduct.getFactory());
    List<ReportStocks> list = rsd.getAll();
    %>
<!DOCTYPE html>
<html lang="zxx" class="js">
<!-- Mirrored from dashlite.net/demo1/hotel/report-stocks.jsp
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <ul class="link-list-opt no-bdr">
                                                                <li><a data-bs-toggle="modal"
                                                                        href="#add-stock"><span>Add Stock</span></a>
                                                                </li>
                                                ...
                                                <div class="card-search search-wrap" data-search="search">
                                                    <div class="card-body">
                                                        <div class="search-content"><a href="#"
                                                                ...
                                                                placeholder="Search by product name or id"><button
                                            ...
                                            <div class="card-inner p-0">
                                                <div class="nk-tb-list nk-tb-ulist">
                                                    <div class="nk-tb-item nk-tb-head">
                                                        ...
                                                        <div class="nk-tb-col"><span class="sub-text">Product
                                                                Name</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span
                                                                class="sub-text">Quantity</span></div>
                                                        <div class="nk-tb-col tb-col-sm"><span class="sub-text">Price
                                                                (pcs / KG)</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span
                                                                        ...
                                                                        <li>
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox"
                                                                                    ...
                                                                                    checked="" id="avil"><label
                                                                                    class="custom-control-label"
                                                                                    for="avil">Available</label></div>
                                                                        </li>
                                                                        <li>
                                                                            <div
                                                                                class="custom-control custom-control-sm custom-checkbox">
                                                                                <input type="checkbox"
                                                                                    class="custom-control-input"
                                                                                    checked="" id="low"><label
                                                                                    class="custom-control-label"
                                                                                    for="low">Low</label></div>
                                                                        </li>
                                                                        <li>
                                                                            <div
                                                                                class="custom-control custom-control-sm custom-checkbox">
                                                                                <input type="checkbox"
                                                                                    ...
                                                                                    id="out"><label
                                                                                    class="custom-control-label"
                                                                                    for="out">Out of Stock</label></div>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb"><span><a
                                                                    href="#"><%=s.getId()%></a></span></div>
                                                        <div class="nk-tb-col"><span><%=s.getProductName()%> <span
                                                                    class="dot dot-success d-md-none ms-1"></span></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md"><span><%=s.getProductQuantity()%> pcs</span></div>
                                                        <div class="nk-tb-col tb-col-sm" data-order="30.00"><span
                                                                class="tb-amount"><%=s.getProductPrice()%>.00 <span
                                                                    class="currency">Rs.</span></span></div>
                                                        <div class="nk-tb-col tb-col-md"><span
                                                                class="tb-status text-success"><%=s.getProductStatus()%></span></div>
                                                                ...
                                                                <li>
                                                                    <div class="drodown"><a href="#"
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-end">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                <li><a data-bs-toggle="modal"
                                                                                        href="#edit-stock<%=s.getId()%>"><em
                                                                                            class="icon ni ni-edit"></em><span>Edit</span></a>
                                                                                </li>
                                                                                <li><a href="../DeleteReportStocks?id=<%=s.getId()%>"><em
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content"><a href="#" class="close" data-bs-dismiss="modal"><em
                ...
                <div class="modal-body modal-body-md">
                    ...
                    <form action="../ReportStocksServlet" method="post" class="mt-2">
                        
                        <div class="row g-gs">
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="product-name-add">Product
                                        Name</label><input type="text" class="form-control" id="product-name-add" name="productName"
                                              placeholder="Product Name" autofocus></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label"
                                        for="quantity-add">Quantity</label><input type="number" class="form-control"
                                              id="quantity-add" name="productQuantity" placeholder="Quantity"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="peice-add">Price</label><input
                                        type="number" class="form-control" id="peice-add" name="productPrice" placeholder="300.99 USD">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="status-add">Status</label><select
                                        class="form-select js-select2" id="status-add" name="productStatus">
                            ...
                            <div class="col-12">
                                <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                    <li><button type="submit" class="btn btn-primary" data-bs-dismiss="modal">Add Stock</button></li>
             ...
             <%for (ReportStocks rs : list) {%>
    <div class="modal fade" tabindex="-1" role="dialog" id="edit-stock<%=rs.getId()%>">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content"><a href="#" class="close" data-bs-dismiss="modal"><em
                        class="icon ni ni-cross-sm"></em></a>
                <div class="modal-body modal-body-md">
                    <h5 class="modal-title">Edit Stock Details</h5>
                    <form action="../UpdateReportStocksServlet" method="post" class="mt-2">
                        
                        <div class="row g-gs">
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="product-name-edit">Product
                                        Name</label><input type="text" class="form-control" id="product-name-edit"
                                       name="productName" value="<%=rs.getProductName()%>" placeholder="Product Name"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label"
                                        for="quantity-edit">Quantity</label><input type="number" class="form-control"
                                        id="quantity-edit" name="productQuantity" value="<%=rs.getProductQuantity()%>pcs" placeholder="Quantity"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="peice-edit">Price</label><input
                                        type="number" class="form-control" id="peice-edit" name="productPrice" value="<%=rs.getProductPrice()%>.00"
                                        placeholder="300.99 USD"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label"
                                        for="edit-status">Status</label><select class="form-select js-select2"
                                               id="edit-status" name="status" value="<%=rs.getProductStatus()%>" >
                                        <option name="productStatus" value="<%=rs.getProductStatus()%>"><%=rs.getProductStatus()%></option>
                                        <option name="productStatus" value="Low">Low</option>
                                        <option name="productStatus" value="Available">Available</option>
                                        <option name="productStatus" value="out of Stock">Out of Stock</option>
                                    </select></div>
                            </div>
                                         <input type="hidden" value="<%=rs.getId()%>" name="id">
                            <div class="col-12">
                                <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                    <li>
