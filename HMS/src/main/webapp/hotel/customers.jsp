...
<!-- Mirrored from dashlite.net/demo1/hotel/customers.jsp
                                            ...
                                            <div class="card-inner p-0">
                                                <div class="nk-tb-list nk-tb-ulist">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb"><span
                                                                class="tb-status text-dark">Dimond</span></div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb"><span
                                                                class="tb-status text-grey">Basic</span></div>
                                                        <div class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-1">
                                                                <li class="nk-tb-action-hidden"><a href="#"
                                                                        class="btn btn-trigger btn-icon"
