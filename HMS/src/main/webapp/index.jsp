<%-- 
    Document   : index
    Created on : 07-Jan-2025, 4:12:35 pm
    Author     : samresh
--%>
                    ...
                    <div class="booking-form">
                        ...
                        <form action="#">
                            <div class="check-date">
                                ...
                                <input type="date" class="date-input" name="checkIn" id="date-in">
                               </div>
                            <div class="check-date">
                                <label for="date-out">Check Out:</label>
                                <input type="date" class="date-input" name="checkOut" id="date-out">
    ...
    <section class="hp-room-section">
        ...
        %>
                    <div class="col-lg-3 col-md-6">
                        <div class="hp-room-item set-bg" data-setbg="../Img/roomImg/<%=ar.getRoomImage()%>">
                            <div class="hr-text">
                                <h3><%=ar.getBedType()%></h3>
                                ...
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>Max persion <%=ar.getBedType()%></td>
                                        </tr>
                                        <tr>
                                            <td class="r-o">Bed:</td>
                                            <td>King <%=ar.getBedType()%> Beds</td>
                                        </tr>
                                        <tr>
                                            <td class="r-o">Services:</td>
                                            <td><%=ar.getDescription()%>Wifi, Television, Bathroom,...</td>
                                        </tr>
                                    </tbody>
                                </table>
                                <a href="room-details.jsp?id=<%=ar.getId()%>" class="primary-btn">More Details</a>
                            </div>
                        </div>
                    </div>
                    <%}%>
