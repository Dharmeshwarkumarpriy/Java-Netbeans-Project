...
<!-- Mirrored from dashlite.net/demo1/hotel/invoice-details.jsp
                            ...
                            <div class="nk-content-body">
                                <div class="nk-block-head">
                                    <div class="nk-block-between g-3">
                                        ...
                                        <div class="nk-block-head-content"><a href="invoice-list.jsp
                                                                              "
                                                class="btn btn-outline-light bg-white d-none d-sm-inline-flex"><em
                                                    class="icon ni ni-arrow-left"></em><span>Back</span></a><a
                                                href="customerDashboard.jsp
                                                "
                                                    ...
                                                    <table class="table table-striped">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="w-150px">Room</th>
                                                                <th class="w-60">Service</th>
                                                                <th>Price</th>
                                                                <th>Qty</th>
                                                                <th>Amount</th>
                                                            </tr>
