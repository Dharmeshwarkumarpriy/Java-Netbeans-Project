...
<%@page import="com.hms.Entity.BlogComment" %>
<%@page import="com.hms.Dao.BlogCommentDao" %>
<%@page import="com.hms.Helper.FactoryProduct" %>
<%@page import="java.util.List" %>
   <%
       BlogCommentDao bcd =new BlogCommentDao(FactoryProduct.getFactory());
       List<BlogComment> list=bcd.getAll();     
    ...
    <section class="blog-details-section">
                ...
                <div class="col-lg-10 offset-lg-1">
                    <div class="blog-details-text">
                        ...
                        <div class="bd-more-text">
                            <div class="bm-item">
                                ...
                                <p>You know all about the traffic there. Getting places is often next to impossible,
                                    even with the gazillion yellow cabs. If youâre like me you often look with envy at
                                    those shiny limousines with their unformed drivers and wish you could sit in one.
                                    Well, you can. New York limo service is more affordable than you think, whether itâs
                        ...
                        <div class="comment-option">
                            <h4>2<%=bcd.getLastId()%> Comments</h4>
                            <div class="single-comment-item first-comment">
                                ...
                                <div class="sc-text">
                                    ...
                                    <a href="blog-details.jsp" class="comment-btn">Reply</a>
                                </div>
                            </div>
                            <div class="single-comment-item reply-comment">
                                ...
                                <div class="sc-text">
                                    ...
                                    <a href="blog-details.jsp" class="comment-btn reply-btn">Reply</a>
                                </div>
                            </div>
        ...
        %>
                        ...
                        <div class="leave-comment">
                            ...
                            <form action="BlogCommentServlet" method="post" class="comment-form">
                                <div class="row">
                                    <div class="col-lg-6">
