...
<!-- Mirrored from dashlite.net/demo1/hotel/index.jsp
by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Dec 2024 12:49:16 GMT -->
<!-- Added by HTTrack -->
...
<body class="nk-body bg-lighter npc-general has-sidebar ">
                                                ...
                                                <div class="card-inner-group">
                                                    <div class="card-inner">
                                                        <div class="card-title-group">
                                                            ...
                                                            <div class="card-tools"><a href="customers.jsp
                                                                                       "
                                                    ...
                                                    <div class="card-inner card-inner-md">
                                                        <div class="user-card">
                                                            ...
                                                            <div class="user-info"><span class="lead-text">Tasnim
                                                                    Ifrat</span><span
                                                                    class="sub-text">tasif-85@example.com</span></div>
                                                            <div class="user-action">
                                                                <div class="drodown"><a href="#"
                                                                        class="dropdown-toggle btn btn-icon btn-trigger me-n1"
                                                                        data-bs-toggle="dropdown"
    ...
    <script src="../assets/js/charts/chart-hotele1e3.js?ver=3.2.4"></script>
</body>
<!-- Mirrored from dashlite.net/demo1/hotel/index.jsp
by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Dec 2024 12:49:42 GMT -->
