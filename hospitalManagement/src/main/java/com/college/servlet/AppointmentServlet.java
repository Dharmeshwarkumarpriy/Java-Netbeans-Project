...
import com.college.dao.AppointmentDao;
...
public class AppointmentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String status = request.getParameter("status");
            ...
            u.setAppointmentDate(appointmentDate);
            u.setDoctorId(doctorId);
            u.setPatientId(patientId);
            u.setStatus(status);

            AppointmentDao ud = new AppointmentDao( FactoryProduct.getFactory());
            ud.saveAppointment(u);

            
            HttpSession h = request.getSession();
            h.setAttribute("message", "Appointment added successfully");
