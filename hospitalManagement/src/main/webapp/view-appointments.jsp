...
<%
    ...
    List<Appointment> list = ad.getAllAppointment();  
    
            PatientDao asd = new PatientDao(FactoryProduct.getFactory());
    List<Patient> list1 = asd.getAllPatient();
...
<body class="invoice-page">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container position-relative d-flex align-items-center justify-content-between">
      ...
      <a class="btn-getstarted" href="view-appointments.jsp">View</a>
...
<table style="height: 100%" width="100%" border="1px solid" class="table table-striped">
