...
<nav class="navbar navbar-expand-lg bg-gradient">
  <div class="container-fluid">
    ...
    <a class="navbar-brand" href="profile.jsp"><div class="logo">
            <img src="img/userPhoto/<%=users.getPhoto()%>" alt="">
        </div></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="Blog.jsp">Home</a>
        </li>
