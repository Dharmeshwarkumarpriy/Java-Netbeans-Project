...
<body class="index-page">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-7">
            ...
            <div class="hero-content" data-aos="fade-left" data-aos-delay="200">
              ...
              <h1 class="hero-title">Excellence in Hospcal Care Since 1985</h1>
                ...
                <div class="stat-group">
                  ...
                  <div class="stat">
                    ...
                    <div class="stat-text">
                      ...
                      <span class="label">Hospcal Specialists</span>
                    </div>
                  </div>
                  <div class="stat">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row">
          <div class="col-lg-8 mx-auto text-center mb-5" data-aos="fade-up" data-aos-delay="150">
            ...
            <p class="lead-description">We are committed to providing world-class Hospcal care through innovation, compassion, and unwavering dedication to our patients' wellbeing and recovery.</p>
          </div>
        </div>
          ...
          <div class="col-lg-7" data-aos="fade-right" data-aos-delay="200">
            <div class="image-grid">
              ...
              <div class="secondary-images">
                ...
                <div class="small-image">
                  <img src="assets/img/health/surgery-2.webp" alt="Hospcal procedure" class="img-fluid">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="content-wrapper">
              <div class="highlight-box">
                ...
                <div class="highlight-content">
                  ...
                  <p>Every treatment plan is carefully customized to meet individual patient needs and Hospcal history.</p>
                </div>
              </div>
              ...
              <div class="action-buttons">
                <a href="about.jsp" class="btn-explore">Explore Our Services</a>
                <a href="contact.jsp" class="btn-contact">
        ...
        <div class="departments-showcase">
            ...
            <div class="row align-items-center">
              <div class="col-lg-6 order-lg-1">
                <div class="department-content">
                  <div class="department-category">Emergency Hospcine</div>
          ...
          <div class="departments-cta" data-aos="fade-up" data-aos-delay="600">
            <div class="cta-content">
              <h3 class="cta-title">Explore All Our Hospcal Departments</h3>
    ...
    <section id="find-a-doctor" class="find-a-doctor section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="200">
          <div class="col-lg-10">
            <div class="search-header">
              <h2>Discover Your Ideal Hospcal Specialist</h2>
              <p>Connect with our network of certified healthcare professionals across all Hospcal disciplines</p>
            </div>
            ...
            <div class="advanced-search-container">
              <form class="search-form" action="forms/doctor-search.php" method="get">
                <div class="search-row">
                  ...
                  <div class="search-field">
                    <label>Hospcal Specialty</label>
                    <div class="select-group">
                      <i class="bi bi-plus-circle"></i>
                      <select class="form-select" name="specialty">
                        <option value="">Select specialty</option>
                        <option value="cardiology">Cardiovascular Hospcine</option>
                        <option value="neurology">Neurological Sciences</option>
                        <option value="orthopedics">Orthopedic Surgery</option>
                        <option value="pediatrics">Pediatric Hospcine</option>
                  ...
                  <div class="search-field">
                    ...
                    <div class="select-group">
                      ...
                      <select class="form-select" name="location">
                        ...
                        <option value="downtown">Downtown Hospcal Center</option>
        ...
        <div class="specialists-showcase" data-aos="fade-up" data-aos-delay="300">
          ...
          <div class="specialist-card" data-aos="slide-up" data-aos-delay="600">
            <div class="card-content">
              ...
              <div class="quick-actions">
                <a href="#" class="action-btn outline">Profile</a>
                <a href="#" class="action-btn primary">login</a>
              </div>
            </div>
          </div>
        ...
        <div class="text-center mt-5" data-aos="fade-up" data-aos-delay="700">
          <a href="specialists.jsp" class="view-all-link">
          ...
          <div class="row align-items-center">
            <div class="col-lg-6">
              <div class="content-wrapper">
                ...
                <p>Discover comprehensive healthcare services delivered with compassion and expertise. Our dedicated team is committed to providing personalized Hospcal care that puts you first.</p>

                <div class="action-buttons">
                  <a href="login.jsp" class="primary-btn">Schedule Consultation</a>
                  <a href="services.jsp" class="secondary-link">
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
              <div class="stat-item">
                ...
                <div class="stat-label">Hospcal Experts</div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6">
              <div class="stat-item">
          ...
          <div class="banner-content">
            <div class="contact-info">
              ...
              <div class="contact-text">
                <h5>Need ImHospate Assistance?</h5>
                <p>Our Hospcal team is available around the clock for urgent consultations and emergency support.</p>
              </div>
            </div>
            <div class="contact-actions">
              ...
              <a href="contact.jsp" class="contact-link">Get Directions</a>
            </div>
          </div>
        </div>
  ...
  <footer id="footer" class="footer position-relative">
    ...
    <div class="container copyright text-center mt-4">
      <p>© <span></span> <strong>Hospital</strong>&nbsp;<span>All Rights Reserved</span></p>
      <div class="credits">
        <!-- All the links in the footer should remain intact. -->
        <!-- You can delete the links only if you've purchased the pro version. -->
        <!-- Licensing information: https://bootstrapmade.com/license/ -->
        <!-- Purchase the pro version with working PHP/AJAX contact form: [buy-url] -->
        Designed by <a href="https://bootstrapmade.com/">dharmeshwar...</a>
      </div>
    </div>
