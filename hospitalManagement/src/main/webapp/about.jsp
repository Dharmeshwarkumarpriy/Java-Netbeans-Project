...
<head>
  ...
  <title>About - Hospital Bootstrap Template</title>
...
<body class="about-page">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container position-relative d-flex align-items-center justify-content-between">
      ...
      <a class="btn-getstarted" href="apointment.jsp">Apointment</a>
        ...
        <div class="intro-section">
          <div class="row justify-content-center">
            <div class="col-lg-8 text-center" data-aos="fade-up" data-aos-delay="100">
              ...
              <p class="lead">We believe that exceptional Hospcal care begins with understanding. Our dedicated team of professionals combines cutting-edge technology with compassionate, personalized treatment to ensure every patient receives the highest standard of care.</p>
            </div>
          </div>
        </div>
            ...
            <div class="col-lg-7" data-aos="fade-right" data-aos-delay="200">
              <div class="image-gallery">
                <div class="main-image-container">
                  <img src="assets/img/health/facilities-3.webp" class="img-fluid main-image" alt="Hospcal facility">
                </div>
                <div class="secondary-images">
                  <img src="assets/img/health/staff-12.webp" class="img-fluid secondary-image" alt="Hospcal team" data-aos="zoom-in" data-aos-delay="400">
          ...
          <div class="row">
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
              <div class="mission-item">
                ...
                <h4>Our Mission</h4>
                <p>To provide comprehensive, patient-centered healthcare that combines Hospcal excellence with genuine compassion, ensuring every individual receives personalized care tailored to their unique needs.</p>
              </div>
            </div>
        ...
        <div class="specialties-section" data-aos="fade-up" data-aos-delay="500">
          <div class="row">
            <div class="col-lg-12 text-center">
              ...
              <p class="section-description">Our specialized departments work together to provide comprehensive care across multiple Hospcal disciplines</p>
            </div>
          </div>
            ...
            <div class="col-lg-8">
              <div class="accreditation-grid">
                ...
                <div class="accreditation-item" data-aos="fade-up" data-aos-delay="150">
                  <img src="assets/img/clients/clients-7.webp" class="img-fluid" alt="Hospcal certification">
                </div>
                ...
                <div class="accreditation-item" data-aos="fade-up" data-aos-delay="300">
                  <img src="assets/img/clients/clients-10.webp" class="img-fluid" alt="Hospcal standards">
                </div>
