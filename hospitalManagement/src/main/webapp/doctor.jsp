...
<head>
  ...
  * Template URL: https://dharmeshwar.com/medinest-bootstrap-hospital-template/
  * Updated: Aug 11 2025 with Bootstrap v5.3.7
  * Author: dharmeshwar.com
  * License: https://dharmeshwar.com/license/
  ======================================================== -->
</head>
...
<body class="doctors-page">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container position-relative d-flex align-items-center justify-content-between">
      ...
      <a class="btn-getstarted" href="doctor.jsp">Doctor</a>
 ...
 <footer id="footer" class="footer position-relative">
    ...
    <div class="container copyright text-center mt-4">
      ...
      <div class="credits">
        ...
        <!-- Licensing information: https://dharmeshwar.com/license/ -->
        <!-- Purchase the pro version with working PHP/AJAX contact form: [buy-url] -->
        Designed by <a href="https://dharmeshwar.com/">dharmeshwar</a>
      </div>
    </div>
