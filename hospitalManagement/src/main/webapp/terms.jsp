...
<head>
  ...
  <title>Terms - hospital Bootstrap Template</title>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="tos-content" data-aos="fade-up" data-aos-delay="200">
          ...
          <div id="user-accounts" class="content-section">
            ...
            <p>When you create an account with us, you must provide accurate, complete, and current information. Failure to do so constitutes a breach of the Terms, which may result in imhospate termination of your account.</p>
            <div class="alert-box">
          ...
          <div id="termination" class="content-section">
            <h3>8. Termination</h3>
            <p>We may terminate or suspend your account imhospately, without prior notice or liability, for any reason whatsoever, including without limitation if you breach the Terms.</p>
          </div>
