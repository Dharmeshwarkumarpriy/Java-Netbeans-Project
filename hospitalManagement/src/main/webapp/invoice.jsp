...
<%
            Doctor d = (Doctor) session.getAttribute("current-user"); if (d == null) {
...
<body class="invoice-page">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container position-relative d-flex align-items-center justify-content-between">
      ...
      <a class="btn-getstarted" href="Invioce.jsp">Invioce</a>
  ...
  <main class="main">
      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1 class="heading-title">Invoice</h1>
              <p class="mb-0">
    ...
    <select name="appointmentId" required>
        ...
        <%
            for (Appointment p : list1) {
        %>
            <option value="<%= p.getId() %>">
                <%= p.getAppointmentDate() %> - <%= p.getStatus() %>
            </option>
       <%}%>
    </select>
    <br><br>
    ...
    <div class="col-md-4">
                    ...
                    <textarea type="textarea" name="discription" rows="10" cols="50" autofocus>                    
...
<!--    <a href="Invoice?patientId= ">
        <button type="submit" class="btn btn-secondary">Generate Invoice</button>
    </a>-->
